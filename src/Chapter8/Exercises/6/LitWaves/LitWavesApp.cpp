...
#include <Chapter8/Exercises/6/LitWaves/FrameResource.hpp>
#include <Chapter8/Exercises/6/LitWaves/Waves.hpp>
...
void LitWavesApp::Draw(const GameTimer& gt)
{
	...
	CD3DX12_RESOURCE_BARRIER transionBarrier = CD3DX12_RESOURCE_BARRIER::Transition(
                CurrentBackBuffer(), D3D12_RESOURCE_STATE_PRESENT,
                D3D12_RESOURCE_STATE_RENDER_TARGET);
        mCommandList->ResourceBarrier(1, &transionBarrier);
	...
	// Indicate a state transition on the resource usage.
	transionBarrier = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(),
...
void LitWavesApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	mMainPassCB.RenderTargetSize = XMFLOAT2((f32)mClientWidth, (f32)mClientHeight);
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"C:\\dev\\d3d12_book\\src\\Chapter8\\Exercises\\6\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"C:\\dev\\d3d12_book\\src\\Chapter8\\Exercises\\6\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_0");
...
void LitWavesApp::BuildRenderItems()
{
	...
	mRitemLayer[(i32)RenderLayer::Opaque].push_back(wavesRitem.get());
	...
	mRitemLayer[(i32)RenderLayer::Opaque].push_back(gridRitem.get());

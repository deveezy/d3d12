...
public:
    DxException() = default;
    DxException(HRESULT hr, const std::wstring& functionName, const std::wstring& filename, i32 lineNumber);
...
struct Light
{
    ...
    f32 FalloffStart = 1.0f;                          // point/spot light only

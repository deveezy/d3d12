...
void D3DApp::OnResize() 
{
    ...
    CD3DX12_RESOURCE_BARRIER transiotionBarrier = CD3DX12_RESOURCE_BARRIER::Transition(mDepthStencilBuffer.Get(),
		D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_DEPTH_WRITE);
	mCommandList->ResourceBarrier(1, &transiotionBarrier);
